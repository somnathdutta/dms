...
public class RolemasterComposer extends GenericForwardComposer{
	...
	RolemasterDAO daoHandler = new RolemasterDAO();
	RolemasterBean webbean = null ;
	...
	public void onSelect$listbox() {
		...
		webbean  = (RolemasterBean)listbox.getSelectedItem().getValue();
	}
	...
	public void onClick$mSave() {
		...
		try{
			...
			webbean.setGroupname(groupname.getValue());
	...
	public void onClick$mEdit(){
		...
		try{
			...
			groupname.setValue(webbean.getGroupname());
