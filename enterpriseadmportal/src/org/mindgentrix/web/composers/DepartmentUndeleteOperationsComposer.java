...
public class DepartmentUndeleteOperationsComposer {
	...
	public DepartmentUndeleteOperationsComposer() {
	...
	void loadAllActiveDepartments() {
		...
		try {
			...
			allDepartments = departmentDAO.findAllInactiveDepartments();
	...
	public void onUpdateDeleteStatusForDepartments() {
		...
		try {
			Messagebox.show("The selected Departments will be undeleted/allowed. Are you sure ?", "Confirm Dialog", 
	...
	public void handleUpdateDeleteStatusForDepartments() {
		...
		try {
			...
			departmentDAO.updateDeleteStatusForDepartments(selectedDepartments,"Y");
			
			Messagebox.show("UNDeleted " + selectedDepartments.size() + " Department(s).");
